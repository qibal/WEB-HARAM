...
@section('admin')
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/IndoHub/admin/vidio/Tambah') }}">vidio</a></li>
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Tambah Vidio</h5>
            ...
            <ul class="nav nav-tabs nav-tabs-bordered" id="borderedTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a href="{{ url('/IndoHub/admin/vidio/Tambah') }}" class="nav-link active">Tambah</a>
                </li>
            </ul>
            <div>
                <div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="judulvidio" id="namakategori" class="form-control mt-2"
                                    placeholder="Mantap " value="{{ old('judulvidio') }}">
                                @error('judulvidio')
                                ...
                                <input type="text" name="durasi" id="durasi" class="form-control mt-2"
                                    placeholder="10:00 " value="{{ old('durasi') }}">
                                @error('durasi')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <input type="text" name="tanggal_upload" id="tanggal_upload" class="form-control mt-2"
                                    placeholder="mei 3 2023 / Di View" value="{{ old('tanggal_upload') }}">
                                @error('tanggal_upload')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                {{-- link poto --}}
                                <label for="linkpoto" class="mt-3">Link Poto</label>
                                <input type="text" name="linkpoto" id="linkpoto" class="form-control mt-2"
                                    placeholder="www.uploadFoto.com / Splash image" value="{{ old('linkpoto') }}">
                                @error('linkpoto')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <input type="text" name="linkvidio" id="namakategori" class="form-control mt-2"
                                    placeholder="www.uploadVidio.com / Embed link" value="{{ old('linkvidio') }}">
                                @error('linkvidio')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
